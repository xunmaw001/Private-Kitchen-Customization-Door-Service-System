...
public class ChushiCommentbackView extends ChushiCommentbackEntity implements Serializable {
	...
	public ChushiCommentbackView() {

	}

	public ChushiCommentbackView(ChushiCommentbackEntity chushiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, chushiCommentbackEntity);
