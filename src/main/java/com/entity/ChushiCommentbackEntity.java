...
public class ChushiCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChushiCommentbackEntity() {

	}

	public ChushiCommentbackEntity(T t) {
		try {
    ...
    @TableField(value = "chushi_commentback_text")
    ...
    public String toString() {
        return "ChushiCommentback{" +
            ", id=" + id +
            ", chushiId=" + chushiId +
            ", yonghuId=" + yonghuId +
            ", chushiCommentbackText=" + chushiCommentbackText +
