               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="厨师信息编号" prop="chushiUuidNumber">
                       <el-input v-model="ruleForm.chushiUuidNumber"
                                 placeholder="厨师信息编号" clearable  :readonly="ro.chushiUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="厨师姓名" prop="chushiName">
                       <el-input v-model="ruleForm.chushiName"
                                 placeholder="厨师姓名" clearable  :readonly="ro.chushiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="厨师手机号" prop="chushiPhone">
                       <el-input v-model="ruleForm.chushiPhone"
                                 placeholder="厨师手机号" clearable  :readonly="ro.chushiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="厨师身份证号" prop="chushiIdNumber">
                       <el-input v-model="ruleForm.chushiIdNumber"
                                 placeholder="厨师身份证号" clearable  :readonly="ro.chushiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="chushiEmail">
                       <el-input v-model="ruleForm.chushiEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.chushiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chushiFile" label="健康认证" prop="chushiFile">
                        <file-upload
                                tip="点击上传健康认证"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.chushiFile?$base.url+ruleForm.chushiFile:''"
                                @change="chushiFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chushiFile" label="健康认证" prop="chushiFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.chushiFile"  >健康认证下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chushiVideo" label="厨艺视频" prop="chushiVideo">
                        <file-upload
                            tip="点击上传厨艺视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.chushiVideo?$base.url+ruleForm.chushiVideo:''"
                            @change="chushiVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chushiVideo" label="厨艺视频" prop="chushiVideo">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="厨师信息介绍" prop="chushiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chushiContent" label="厨师信息介绍" prop="chushiContent">
                            <span v-html="ruleForm.chushiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    chushiUuidNumber: false,
                    username: false,
                    password: false,
                    chushiName: false,
                    chushiPhone: false,
                    chushiIdNumber: false,
                    chushiPhoto: false,
                    sexTypes: false,
                    chushiEmail: false,
                    chushiFile: false,
                ...
                ruleForm: {
                    chushiUuidNumber: new Date().getTime(),
                    username: '',
                    password: '',
                    chushiName: '',
                    chushiPhone: '',
                ...
                rules: {
                   chushiUuidNumber: [
                              { required: true, message: '厨师信息编号不能为空', trigger: 'blur' },
                          ],
                   username: [
                   ...
                   chushiName: [
                              { required: true, message: '厨师姓名不能为空', trigger: 'blur' },
                          ],
                   chushiPhone: [
                              {  required: true, message: '厨师手机号不能为空', trigger: 'blur' },
                   ...
                   chushiIdNumber: [
                              { required: true, message: '厨师身份证号不能为空', trigger: 'blur' },
                   ...
                   chushiPhoto: [
                              { required: true, message: '厨师头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   chushiFile: [
                              { required: true, message: '健康认证不能为空', trigger: 'blur' },
                          ],
                   chushiVideo: [
                              { required: true, message: '厨艺视频不能为空', trigger: 'blur' },
                          ],
                   chushiContent: [
                              { required: true, message: '厨师信息介绍不能为空', trigger: 'blur' },
                          ],
                   chushiDelete: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.chushiContent = _this.ruleForm.chushiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.chushiContent = this.ruleForm.chushiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`chushi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chushiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            chushiFileUploadChange(fileUrls){
                this.ruleForm.chushiFile = fileUrls;
                this.addEditUploadStyleChange()
            },
            chushiVideoUploadChange(fileUrls){
                this.ruleForm.chushiVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
