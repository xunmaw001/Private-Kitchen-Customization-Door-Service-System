    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="chushiCommentbackText">
                        <el-input type="textarea"  :readonly="ro.chushiCommentbackText" v-model="ruleForm.chushiCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chushiCommentbackText" label="评价内容" prop="chushiCommentbackText">
                            <span v-html="ruleForm.chushiCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.chushiId = true;//厨师信息
                this.ro.yonghuId = true;//用户
                this.ro.chushiCommentbackText = true;//评价内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chushiCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chushiCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
