    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">私房菜定制上门服务系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="厨师姓名" class="input" v-if="tableName=='chushi'">
                            <el-input v-model="ruleForm.chushiName" autocomplete="off" placeholder="厨师姓名"  />
                        </el-form-item>
                        <el-form-item label="厨师手机号" class="input" v-if="tableName=='chushi'">
                            <el-input v-model="ruleForm.chushiPhone" autocomplete="off" placeholder="厨师手机号"  />
                        </el-form-item>
                        <el-form-item label="厨师身份证号" class="input" v-if="tableName=='chushi'">
                            <el-input v-model="ruleForm.chushiIdNumber" autocomplete="off" placeholder="厨师身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='chushi'">
                            <el-input v-model="ruleForm.chushiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.chushiName)&& 'chushi'==this.tableName){
                                this.$message.error('厨师姓名不能为空');
                                return
                            }
                             if('chushi' == this.tableName && this.ruleForm.chushiPhone&&(!this.$validate.isMobile(this.ruleForm.chushiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.chushiIdNumber)&& 'chushi'==this.tableName){
                                this.$message.error('厨师身份证号不能为空');
                                return
                            }
                            if('chushi' == this.tableName && this.ruleForm.chushiEmail&&(!this.$validate.isEmail(this.ruleForm.chushiEmail))){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/sifangcaidingzhishangmenfuwu/img/back-img-bg.jpg);
